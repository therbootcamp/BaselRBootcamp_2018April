...
```{r, echo = FALSE}
knitr::opts_chunk$set(comment=NA, fig.width=6, fig.height=6, echo = TRUE, eval = TRUE, message = FALSE, warnings = FALSE, fig.align = 'center')
```


### Slides

- [Here are the introduction slides for this practical on machine learning II!](https://therbootcamp.github.io/_sessions/D3S1_MachineLearningII/MachineLearningII.html)
...
```{r}
boston_ridge_train <- caret::train(form = medv ~ ., 
                                   data = boston_train,
                                   method = "ridge",
                                   trControl = rep10_control)
...
```{r}
boston_rf_train <- caret::train(form = medv ~ ., 
                                   data = boston_train,
                                   method = "rf",
                                   trControl = rep10_control)
...
mlr::summarizeColumns(heartdisease_train)

ggpairs(heartdisease_train)
```
