...
You'll use two datasets in this practical: `heartdisease.csv`, and `ACTG175.csv`
...
heart <- read_csv(file = "data/heartdisease.csv")   # Save a copy of the heartdisease data as heart
